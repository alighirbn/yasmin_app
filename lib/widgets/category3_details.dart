...
class Category3Details extends StatelessWidget {
  final ColorScheme colorScheme;
  final TextTheme textTheme;

  const Category3Details({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Column(
        ...
        children: [
          Image.asset(
            'assets/bc30.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ),
          ...
          Image.asset(
            'assets/bc32.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ),
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 8.0),
          ...
          Image.asset(
            'assets/bc31.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ),
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 8.0),
          ...
          Image.asset(
            'assets/bc34.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ),
        ],
      ),
